            ...
            for (int i = 0; i < ChangedMaterialCount; i++)
            {
                ...
                for (int i3 = 0; i3 < MaterialCount; i3++)
                {
                    ...
                    if(CurrentMaterial.TilingChanged) {
                        TempMat.AlbedoTextureScale = new Vector4(CurrentMaterial.SharedMaterials[Index].mainTextureScale.x, CurrentMaterial.SharedMaterials[Index].mainTextureScale.y, CurrentMaterial.SharedMaterials[Index].mainTextureOffset.x, CurrentMaterial.SharedMaterials[Index].mainTextureOffset.y);
                    }
