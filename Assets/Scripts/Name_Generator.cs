...
public static class Name_Generator
{
    ...
    public static Color[] GetRandomPalette(int seed)
    {
    ...
    static readonly ReadOnlyCollection<string> randomColors = new ReadOnlyCollection<string>(new string[] {
       "#A33E1F","#A9DEEF","#AB4121","#E5F5FA","#010304",
       "#5791CB","#D0D0F1","#3ABBBB","#F8F0E8","#1B1208",
       "#5FBF85","#D3D6EE","#AF4685","#F2F0DE","#161509",
       "#DA5279","#AFEEBD","#25AD86","#FEFBFD","#190515",
       "#4706EA","#FDECAF","#9EDB06","#F5F7FF","#000000",
       "#A890B6","#E9DDE7","#976390","#F6F6F9","#13121C",
       "#5d54de","#f5ccf2","#3227ce","#ffffff","#000000",
       "#0d7810","#acf6ae","#14c21a","#f1fef2","#000501",
       "#9d7c6c","#cbdac8","#567281","#fdfcfd","#060406",
       "#d33c3e","#bcbdf0","#2cb72a","#e6e6f9","#040411",
       "#264ac9","#f3e7bf","#2547c1","#f8f1d8","#110e03",
       "#773173","#cce8ea","#a0a744","#e9f5f6","#040a0b",
       "#1a679e","#edb0f2","#b85e1e","#daf9d8","#010401",
       "#ef2525","#f9f9c8","#dbdb1a","#fefafa","#170303",
       "#ef2525","#a5fdfd","#6b04d2","#fed7d7","#140000",
       "#ef2525","#e3e3d9","#8b8b65","#f4f0f0","#000000",
       "#ef2525","#dadaf1","#47b8b8","#f6e9e9","#120707",
       "#ef6425","#fec8af","#4803dd","#ffeee6","#140700",
       "#ef6425","#ebfdc3","#a5ef06","#feddcd","#230c01",
"#ef6425","#d5dadd","#666b7f","#fafaf9","#000000",
"#ef6425","#e3f0c6","#8fbb30","#fefcfb","#180c06",
"#efe125","#efd1c3","#b55a30","#fdf9f7","#080402",
"#efe125","#e6e2b3","#923399","#fcfcf7","#171608",
"#efe125","#f1cdf4","#2d38c8","#f6f3d5","#151405",
"#efe125","#b5f7b1","#21c615","#fffefa","#050400",
"#efe125","#f7f5d4","#d9cd26","#faf9e5","#0d0c02",
"#97ef25","#c7a5f3","#b51722","#effbdf","#060901",
"#97ef25","#d1eadc","#4aa572","#f0f6ea","#0d1208",
"#97ef25","#dceec3","#b3327b","#ffffff","#162009",
"#25ef94","#c3e5d5","#987243","#dcefe6","#0b1913",
"#554920","#d9eed3","#b19843","#e1e6f4","#0d1121",
"#7a5487","#e2e5d6","#6a935c","#ebe9f1","#121019",
"#9fc9df","#b6d6e7","#34789d","#f0f6fa","#010304",
"#3c4349","#dbdee1","#6c7984","#f1f2f4","#070808",
"#485bd5","#f2c5e1","#bfab2b","#d5f6e1","#010402",
"#a7ae24","#ebefaf","#a7ae24","#ffffff","#212207",
"#eca2a4","#eeaaad","#a92327","#ffffff","#260809",
"#08399b","#fccec5","#e99f0c","#e7fafe","#000000",
"#815a5e","#e0d7d2","#876f5e","#f2edf0","#060405",
"#dcb7d1","#dbebd6","#51a468","#eaddee","#150c18",
"#c02d16","#f3f9cd","#e0351a","#fafefe","#03181b",
"#97aaa9","#d6cdd2","#766062","#f4f6f5","#0b0e0d",
"#d57962","#efcbc3","#b54b30","#f6e4df","#140805",
"#20c6f8","#e8fca6","#d006a1","#f5fed7","#131901",
"#b20639","#fdbfb0","#da3107","#fff0fc","#23011c",
"#f7cf7d","#c0f2fb","#0d54e3","#feefec","#220702",
"#c9314d","#eee4b9","#b12b43","#effbf9","#020807",
"#14730d","#f6cdf9","#26e119","#fdf1fd","#1e0420",
"#7a4b05","#f6fcbf","#e6200a","#e7f0fe","#02132c",
"#b0f745","#d2b6fc","#88dc09","#e4d3fd","#020005",
"#0a4ecd","#befa9e","#c3094a","#ecfee2","#040a00",
"#010f79","#fed3b8","#e8cd02","#f5fbff","#011f32",
"#24194d","#e7d8b6","#889d34","#dde3f4","#0d1426",
"#4ccd82","#c7efd8","#34b76a","#d7f4e3","#07180e",
"#2d3f58","#e8dfd3","#51739e","#eee7dd","#18130c",
"#673c5c","#dceae0","#9d5c8c","#ffffff","#09100b",
"#27be99","#c5b7f0","#b62549","#f5fae6","#141905",
"#dfa990","#e8c2b0","#9e512e","#f5e3db","#0c0603",
"#1446c2","#f8e8be","#164cd4","#fcf5e3","#2a1f04",
"#833d0b","#b9f9f4","#1283d3","#ffffff","#1c0205",
"#dc2885","#f8d3e6","#db2483","#fef6fa","#090105",
"#9fc1a1","#caddcc","#56865a","#ffffff","#020302",
"#8c3b65","#dbf0e5","#b44b81","#f4faf7","#0c1d14",
"#ebd8ad","#e8f1c6","#a0bc2f","#faeeeb","#040201",
"#7e43d6","#f5d1e7","#6d2dcd","#f2f9e6","#090d03",
"#7246e2","#eaf7ca","#5421d4","#eef8d3","#030401",
"#7d2a17","#f4ccc3","#c64224","#fdf4f2","#110603",
"#d2d908","#b5d6fc","#0f08dd","#ffffff","#311b02",
"#fc9ce7","#fda5ea","#d105a5","#fee1f8","#050004",
"#de87d8","#d7f2f4","#bec837","#fbfefe","#071718",
"#dba9af","#cdd1ea","#52a545","#edeef7","#06070e",
"#752ac6","#f4cdf4","#2b2dca","#f3fbea","#152207",
"#0cca5e","#f9cafc","#ec0e8c","#ffffff","#031d02",
"#2d3934","#d9d5ce","#70607b","#f4f3f1","#0e0d0b",
"#8ce8c5","#f6d0f1","#d12969","#d4f7d8","#041506",
"#9bf3f1","#f9cde4","#de1b1f","#fafefc","#052916",
"#385494","#d5ebcb","#aa4160","#f9fcf8","#080f06",
"#903218","#e2f1ac","#b33e1e","#eef9fc","#05191f",
});

    static readonly ReadOnlyCollection<string> firstNames1900s = new ReadOnlyCollection<string>(new string[] {
    ...
    static readonly ReadOnlyCollection<string> firstNames1910s = new ReadOnlyCollection<string>(new string[] {
    ...
    static readonly ReadOnlyCollection<string> firstNames1920s = new ReadOnlyCollection<string>(new string[] {
    ...
    static readonly ReadOnlyCollection<string> firstNames1930s = new ReadOnlyCollection<string>(new string[] {
    ...
    static readonly ReadOnlyCollection<string> firstNames1940s = new ReadOnlyCollection<string>(new string[] {
    ...
    static readonly ReadOnlyCollection<string> firstNames1950s = new ReadOnlyCollection<string>(new string[] {
    ...
    static readonly ReadOnlyCollection<string> firstNames1960s = new ReadOnlyCollection<string>(new string[] {
    ...
    static readonly ReadOnlyCollection<string> firstNames1970s = new ReadOnlyCollection<string>(new string[] {
    ...
    static readonly ReadOnlyCollection<string> lastNames = new ReadOnlyCollection<string>(new string[] {
