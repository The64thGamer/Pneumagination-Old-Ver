...
ChunkRenderData RenderChunk(int index)
{
	...
	return new ChunkRenderData() { chunkNode = chunk, meshNode = meshObject, position = new Vector3(currentlyLoadedChunks[index].positionX * 128, 0, currentlyLoadedChunks[index].positionZ * 128) };
}
